...
double problems::dejong5(double* args, int n)
{
	double result = 0.002;
	for(int i = 0; i < 25; i++)
	{
...
double problems::easom(double* args, int n)
{
	if(n < 2) return 0;
...
double problems::michalewicz(double* args, int n, int m)
{
	double result = 0;
...
double problems::michalewicz2(double* args, int n)
{
