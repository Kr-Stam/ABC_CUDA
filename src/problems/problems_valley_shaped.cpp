...
double problems::three_hump_camel(double* args, int n)
{
...
double problems::six_hump_camel(double* args, int n)
{
	double x2 = args[0]*args[0];
...
double problems::dixon_price(double* args, int n)
{
	double result = 0;
	double tmp = (args[0] - 1);
...
double problems::rosenbrock(double* args, int n)
{
	double result = 0;
	for(int i = 0; i < n - 1; i++)
	{
