...
__device__ double problems::gpu::ackley(double* args, int n, double a, double b, double c)
{
	double result;
	double sum_x2 = 0;
	double sum_cx = 0;
...
__device__ double problems::gpu::ackley2(double* args, int n)
{
	return ackley(args, n, 20, 0.2, 2*M_PI);
}

///\note this function is only a 2d function
__device__ double problems::gpu::bukin6(double* args, int n)
{
	if(n < 2) return 0;
...
__host__ __device__ double problems::gpu::cross_in_tray(double* args, int n)
{
	if(n < 2) return 0;
...
///\note this function in only a 2d function
__device__ double problems::gpu::drop_wave(double* args, int n)
{
	if(n < 2) return 0;
...
///\note this function in only a 2d function
__device__ double problems::gpu::eggholder(double* args, int n)
{
	if(n < 2) return 0;
...
__device__ double problems::gpu::gramacy_and_lee(double* args, int n)
{
	if(n < 1) return 0;
...
__device__ double problems::gpu::griewank(double* args, int n)
{
	double result  = 0;
	double product = 1;
	for(int i = 0; i < n; i++)
...
__device__ double problems::gpu::holder_table(double* args, int n)
{
	if(n < 2) return 0;
...
__device__ double problems::gpu::langerman(double* args, int n, double* c, int m, double* A)
{
	double result = 0;
	for(int i = 0; i < m; i++)
	{
...
__device__ double problems::gpu::langerman2(double* args, int n)
{
	double A[] = {
		3, 5,
		5, 2,
...
__device__ double problems::gpu::levy(double* args, int n)
{
	double tmp, tmp1;
	double result = 0;
...
__device__ double problems::gpu::levy13(double* args, int n)
{
	if(n < 2) return 0;
...
__device__ double problems::gpu::rastrigin(int a, double* x, int n)
{
	float result = a * n;
	for(int i = 0; i < n; i++)
	{
...
///      definition
__device__ double problems::gpu::rastrigin2(double* args, int n)
{
	return rastrigin(10, args, n);
}

///\note This is only a 2d function
__device__ double problems::gpu::schaffer2(double* args, int n)
{
	if(n < 2) return 0;
...
///\note This is only a 2d function
__device__ double problems::gpu::schaffer4(double* args, int n)
{
	if(n < 2) return 0;
...
__device__ double problems::gpu::schwefel(double* args, int n)
{
...
///\note This is only a 2d function
__device__ double problems::gpu::shubert(double* args, int n)
{
	if(n < 2) return 0;
	double sum1 = 0;
	double sum2 = 0;
